...
The canonical contributor guide lives in [`CONTRIBUTING.md`](https://github.com/MHChlagou/aegis/blob/main/CONTRIBUTING.md) at the repo root. This page is a short orientation for readers of the documentation site.

## Quick links

- Full guide: [`CONTRIBUTING.md`](https://github.com/MHChlagou/aegis/blob/main/CONTRIBUTING.md)
- Code of conduct: [`CODE_OF_CONDUCT.md`](https://github.com/MHChlagou/aegis/blob/main/CODE_OF_CONDUCT.md)
- Security reports: [`SECURITY.md`](https://github.com/MHChlagou/aegis/blob/main/SECURITY.md)
...
These paths have [CODEOWNERS](https://github.com/MHChlagou/aegis/blob/main/.github/CODEOWNERS) guarding them and require reviews from the listed teams in addition to regular maintainer approval:
